        ...
        *,
        ...
        super().__init__(
            ...
            endpoints=lambda svc: {
                "/grpc.reflection.v1alpha.ServerReflection/ServerReflectionInfo": Endpoint.bidi_stream(
                    method=MethodInfo(
...
class ServerReflectionWSGIApplication(ConnectWSGIApplication):
    def __init__(
        ...
        super().__init__(
            endpoints={
                "/grpc.reflection.v1alpha.ServerReflection/ServerReflectionInfo": EndpointSync.bidi_stream(
                    method=MethodInfo(
                        name="ServerReflectionInfo",
                        service_name="grpc.reflection.v1alpha.ServerReflection",
                        input=ServerReflectionRequest,
